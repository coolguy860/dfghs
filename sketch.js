...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    ground.velocityX = -4;
    //scoring
    score = score + Math.round(frameCount/199)
...
function spawnObstacles(){
 if (frameCount % 180 === 0){
   var obstacle = createSprite(400,invisibleGround.y - 18,10,40);
...
function spawnClouds() {
  ...
  if (frameCount % 180 === 0) {
    cloud = createSprite(width + 100,height/2 + 100,40,10);
